...
%\begin{figure}
%	\centering
%	\fbox{\includegraphics[width=\linewidth]{figures/empty.png}}
	%\fbox{\includegraphics[width=\linewidth]{figures/fig-texturing-rescue.png}}
%	\caption{The Bremen Rescue Arena with two projected images. The images did not contain location or orientation information, so they are manually positioned.}
%	\label{fig:texturing}
%\end{figure}
...
\begin{figure*}
	...
	\caption{Two examples of immersive environments. Rendering the voxel data in a portable dome environment (a) allows many people to analyze the data simultaneously, while head-mounted displays increase the immersion for a single user (b).}
	\label{fig:immersive}
\end{figure*}
